...
public class FrCadAluno extends javax.swing.JFrame {
    ...
    private int novoOuEditar = 0;//=0 caso seja clicado no botão Novo ou =1 no editar
    private int indiceDeEdicao = -1;
    ...
    public String mostrarLista() {
        String listaCompleta = ""; //variavel de texto
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        preencheCamposParaEdicao(indiceDeEdicao);
